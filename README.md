...
|-----|-----|-----|-----|-----|
|1|[Анализ данных о массовых увольнениях](https://github.com/SiriusSergio/portfolio/tree/main/pet_projects/World%20layoffs%20analysis)| Экономика |Очистка и предобработка данных о массовых увольнениях в различных компаниях, а также выполнение исследовательского анализа данных (EDA) |`PostgreSQL`|
<!---
