...
|3|[Определение текущего уровня потребительской лояльности (NPS) в телекоммуникационной компании]()| Телекоммуникации | Сбор витрины из БД, выгрузка данных, построение дашборда, анализ NPS, оценка категорий клиентов | `sqlalchemy` `os` `pandas` `numpy`|
